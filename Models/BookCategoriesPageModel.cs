...
namespace Lutac_Ecaterina_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Lutac_Ecaterina_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Lutac_Ecaterina_Lab2Context context,

...
namespace Lutac_Ecaterina_Lab2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Lutac_Ecaterina_Lab2.Data.Lutac_Ecaterina_Lab2Context context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            Input.Password);
            /*
             ///Am mutat aceste 3 linii mai jos (>*<) deoarece (cred) din cauza liniei
             ///await _context.SaveChangesAsync();
             ///nu mai ajungeam la partea de Confirm Registration (ergo nu mi se salva userul)
